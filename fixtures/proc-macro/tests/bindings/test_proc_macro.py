...
trait_impl2 = obj.get_trait_with_callback_interface(None)
assert trait_impl2.name() == "TraitWithCallbackInterfaceImpl"
assert obj.get_trait_with_callback_interface(trait_impl2).name() == "TraitWithCallbackInterfaceImpl"
...
assert get_trait_with_callback_interface(None).name() == "TraitWithCallbackInterfaceImpl"
